...
function f(t1, t2, p1, p2) {
  return (
    ((6 / (m * l * l)) * (2 * p1 - 3 * Math.cos(t1 - t2) * p2)) /
    (16 - 9 * Math.cos(t1 - t2) * Math.cos(t1 - t2))
  );
}

function g(t1, t2, p1, p2) {
  return (
    ((6 / (m * l * l)) * (8 * p2 - 3 * Math.cos(t1 - t2) * p1)) /
    (16 - 9 * Math.cos(t1 - t2) * Math.cos(t1 - t2))
  );
}
...
function j(t1, t2, p1, p2) {
  return (
    ...
    l *
    l *
    (f(t1, t2, p1, p2) * g(t1, t2, p1, p2) * Math.sin(t1 - t2) +
      ((3 * gr) / l) * Math.sin(t1))
  );
}
...
function k(t1, t2, p1, p2) {
  return (
    ...
    l *
    l *
    (-1 * f(t1, t2, p1, p2) * g(t1, t2, p1, p2) * Math.sin(t1 - t2) +
      (gr / l) * Math.sin(t2))
  );
}
